...
public final class ContractHierarchyMessages extends NLS {

	private static final String BUNDLE_NAME= "net.sourceforge.c4jplugin.internal.ui.contracthierarchy.ContractHierarchyMessages";//$NON-NLS-1$

	private ContractHierarchyMessages() {
		// Do not instantiate
	}
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, ContractHierarchyMessages.class);
	}
}
