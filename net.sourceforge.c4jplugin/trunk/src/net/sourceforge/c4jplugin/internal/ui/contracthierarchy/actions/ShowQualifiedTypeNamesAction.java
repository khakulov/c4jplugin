...
public class ShowQualifiedTypeNamesAction extends Action {
	...
	public ShowQualifiedTypeNamesAction(ContractHierarchyViewPart v, boolean initValue) {
		super(ContractHierarchyMessages.ShowQualifiedTypeNamesAction_label); 
		setDescription(ContractHierarchyMessages.ShowQualifiedTypeNamesAction_description); 
		setToolTipText(ContractHierarchyMessages.ShowQualifiedTypeNamesAction_tooltip); 
