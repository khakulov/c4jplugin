...
public abstract class ContractHierarchyViewer extends ProblemTreeViewer {
	
	private OpenAction fOpen;
	private HierarchyLabelProvider fLabelProvider;
			
	public ContractHierarchyViewer(Composite parent, IContentProvider contentProvider, ContractHierarchyLifeCycle lifeCycle,  IWorkbenchPart part) {
	...
	public void setMemberFilter(IMember[] memberFilter) {
		ContractHierarchyContentProvider contentProvider= getHierarchyContentProvider();
	...
	protected ContractHierarchyContentProvider getHierarchyContentProvider() {
		return (ContractHierarchyContentProvider)getContentProvider();
	}
