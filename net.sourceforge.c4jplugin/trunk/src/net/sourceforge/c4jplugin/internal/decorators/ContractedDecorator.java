 ...
 */
public class ContractedDecorator extends LabelProvider implements ILightweightLabelDecorator {
	
	static public final String ID = "net.sourceforge.c4j.plugin.decorators.Contracted";
	...
	private String classIcon = "icons/contracted.gif"; //NON-NLS-1
